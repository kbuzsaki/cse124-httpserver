...
CXXFLAGS = $(CFLAGS)
DEPS = httpd.h connection.h util.h http.h server.h mocks.h listener.h request_handlers.h file_repository.h connection_handlers.h synchronized_queue.h htaccess.h dns_client.h
SRCS = httpd.cpp connection.cpp util.cpp http.cpp server.cpp mocks.cpp listener.cpp request_handlers.cpp file_repository.cpp connection_handlers.cpp htaccess.cpp dns_client.cpp
OBJ_DIR = build
